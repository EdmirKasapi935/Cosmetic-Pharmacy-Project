        ...
        <tbody>
          <?php foreach($customerList as $row): ?>
            <tr>
              ...
              <td data-label="Price"><?= $row["EmailAdd"] ?></td>
              <td data-label="Stock"><?= $row["RegitrationDate"] ?></td>
              <td data-label="Delete">
                <form action="/admin/unsubCustomer" method="POST" class="delete-form">
                  <input type="hidden" name="customerToDelete" value="<?= $row["ID"] ?>" >
